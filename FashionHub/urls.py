...
url(r'^log_out/$',Logout,name='log_out'),
...
#url(r'^informate/(?P<pid>[0-9]+)/$',info,name='information'),
url(r'^donate_amt/$',donate_amount,name='damt'),
#url(r'^paymoney/(?P<a>[0-9]+)/$',Pay_money,name='pay_money')
